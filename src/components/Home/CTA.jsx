...
export default function CTA() {
    return (
        <section className="py-20 bg-gray-100 relative overflow-hidden">
            ...
            <div className="max-w-[1250px] mx-auto px-5 md:px-10 relative z-10">
                <motion.div
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-stretch sm:items-center">
                        ...
                        >
                            <Link
                                to="/contact"
                                className="w-full inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
